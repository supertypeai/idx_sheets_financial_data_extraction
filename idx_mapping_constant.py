...
BALANCE_SHEET_METRICS_NON_BANK = [
    "total_current_asset",
...
INCOME_STATEMENT_METRICS_NON_BANK = [
    "total_revenue",
    "cost_of_revenue",
    "gross_income",
    "operating_expense",
...
GENERAL_ADDITIONAL_MAPPING = [
    (["1670000"], {"depreciation_amortization": ["Depreciation", "Amortizaion"]})
]
...
PROPERTY_ADDITIONAL_MAPPING = [
    (["2670000"], {"depreciation_amortization": ["Depreciation", "Amortizaion"]})
]
